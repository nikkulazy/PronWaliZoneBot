...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if data == "my_plan_callback":
        ...
        return
Key Changes:
Import change: START_PIC → START_PICS (list)

Photo line: photo=random.choice(START_PICS)

Auto-delete: asyncio.create_task(delete_after_30(sent_message, message))

Delete function: Alag se banaya delete_after_30

Remove: await msg.delete() (galat line)

Agar Aapko 60 second chahiye to:
python
# Line change kareIN
asyncio.create_task(delete_after_60(sent_message, message))

# Aur function name change kareIN
async def delete_after_60(sent_message, user_message):
